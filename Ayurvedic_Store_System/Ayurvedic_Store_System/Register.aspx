<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Ayurvedic_Store_System.Register" %>
...
<body>
    ...
    <div class="container">
            ...
            <asp:TextBox runat="server" ID="tb_Name" placeholder="Enter Name Here" 
                ></asp:TextBox>
