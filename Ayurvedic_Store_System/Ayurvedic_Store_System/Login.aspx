<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Ayurvedic_Store_System.Login" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
           <br />
            <asp:HyperLink ID="HyperLink1" runat="server" style="margin-left: 80px" NavigateUrl="~/Register.aspx">Don&#39;t Have an Account Register Now</asp:HyperLink>
        </div>
