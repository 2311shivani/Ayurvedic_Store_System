...
<body>
    ...
    <div id="container">
        ...
        &nbsp;&nbsp;
            <asp:DropDownList ID="cmb_Category" runat="server" Height="42px" 
        ...
        <asp:Label ID="lbl_PName" runat="server" Text="Product Name" Font-Names="Arial" 
                Font-Size="25px"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="cmb_Product_Name" runat="server" Height="63px" 
                Width="201px">
            </asp:DropDownList><br /><br />
    ...
    <div id="div4">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btn_Update" runat="server" BackColor="#FF9933" Font-Bold="True" 
                ...
                Width="121px" onclick="btn_Update_Click" />
        </div> 
