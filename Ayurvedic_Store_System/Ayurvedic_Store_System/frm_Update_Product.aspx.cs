    ...
    public partial class frm_Update_Product : System.Web.UI.Page
    {
        ...
        protected void btn_save_Click(object sender, EventArgs e)
        {
            ...
            if (cmb_Category.Text != "" && cmb_Product_Name.Text != "" && tb_Purchase_Price.Text != "" && tb_Sales_Price.Text != "" && tb_Desc.Text != "")
            {
                ...
                cmd.CommandText = "insert into Product_Details(Category,Product_Name,Purchase_Price,Sales_Price,Description) Values ('" + cmb_Category.Text + "', '" + cmb_Product_Name.Text + "', '" + tb_Purchase_Price.Text + "', '" + tb_Sales_Price.Text + "', '" + tb_Desc.Text + "')";
